    ...
    <main style={{ minHeight: "100dvh" }}>
      ...
      <section style={{
        ...
        <div aria-hidden style={{ position: "absolute", inset: 0, pointerEvents: "none", zIndex: 0 }}>
          ...
          <div style={{
            ...
            background: "radial-gradient(ellipse, rgba(240,100,140,0.08) 0%, transparent 70%)",
            filter: "blur(60px)",
          }} />
          <div style={{
          ...
          <div style={{
            ...
            width: "300px", height: "300px",
            background: "radial-gradient(circle, rgba(240,160,184,0.06) 0%, transparent 70%)",
            filter: "blur(50px)",
          }} />
        </div>
        ...
        <div style={{
          ...
          animation: "fadeSlideUp 1.1s cubic-bezier(0.16,1,0.3,1) 0.1s both",
        }}>
          {/* Eyebrow */}
          <div style={{
            ...
            <span style={{
              ...
              textTransform: "uppercase", color: "rgba(212,168,83,0.8)",
            }}>
          ...
          <h1 style={{
            ...
            color: "#f7cdd8", marginBottom: "0.5rem",
          ...
          <h1 style={{
            fontFamily: "'Cormorant Garamond', Georgia, serif",
            fontSize: "clamp(3.5rem, 10vw, 8rem)",
            fontWeight: 300, lineHeight: 0.92, fontStyle: "italic",
            background: "linear-gradient(135deg, #d4a853, #f0a0b8, #d4a853)",
          ...
          {/* Stats row — dynamiczne z hydratowanego store */}
          <div style={{
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{
                ...
                color: "rgba(240,160,184,0.35)", marginTop: "4px",
              }}>
                Piosenek
              </div>
            </div>
      ...
      <div style={{ textAlign: "center", padding: "4rem 1rem 2rem" }}>
        <p style={{
          ...
          color: "rgba(247,205,216,0.6)", letterSpacing: "0.02em",
        }}>
          Nasza oś czasu
        </p>
        <div style={{
      ...
      {!ready ? (
        ...
        <div style={{
          ...
          {[1, 2, 3].map((n) => (
            <div key={n} style={{
              height: "120px", borderRadius: "1rem",
      ...
      <footer style={{
        ...
        <div style={{
          fontFamily: "'Cormorant Garamond', serif",
          fontSize: "1.1rem", fontStyle: "italic", fontWeight: 300,
          color: "rgba(240,160,184,0.2)", letterSpacing: "0.05em",
        }}>
